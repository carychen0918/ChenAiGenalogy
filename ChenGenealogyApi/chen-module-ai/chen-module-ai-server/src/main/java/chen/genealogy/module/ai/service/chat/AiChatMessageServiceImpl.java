package chen.genealogy.module.ai.service.chat;
...
import chen.genealogy.framework.tenant.core.util.TenantUtils;
import chen.genealogy.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import chen.genealogy.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import chen.genealogy.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import chen.genealogy.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import chen.genealogy.module.ai.dal.dataobject.chat.AiChatConversationDO;
import chen.genealogy.module.ai.dal.dataobject.chat.AiChatMessageDO;
import chen.genealogy.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import chen.genealogy.module.ai.dal.dataobject.model.AiChatRoleDO;
import chen.genealogy.module.ai.dal.dataobject.model.AiModelDO;
import chen.genealogy.module.ai.dal.dataobject.model.AiToolDO;
import chen.genealogy.module.ai.dal.mysql.chat.AiChatMessageMapper;
import chen.genealogy.module.ai.enums.ErrorCodeConstants;
import chen.genealogy.module.ai.enums.model.AiPlatformEnum;
import chen.genealogy.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import chen.genealogy.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import chen.genealogy.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import chen.genealogy.module.ai.service.knowledge.AiKnowledgeDocumentService;
import chen.genealogy.module.ai.service.knowledge.AiKnowledgeSegmentService;
import chen.genealogy.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import chen.genealogy.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import chen.genealogy.module.ai.service.model.AiChatRoleService;
import chen.genealogy.module.ai.service.model.AiModelService;
import chen.genealogy.module.ai.service.model.AiToolService;
import chen.genealogy.module.ai.util.AiUtils;
import chen.genealogy.module.ai.util.FileTypeUtils;
...
import static chen.genealogy.framework.common.pojo.CommonResult.error;
...
import static chen.genealogy.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static chen.genealogy.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 chen.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 chen.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
