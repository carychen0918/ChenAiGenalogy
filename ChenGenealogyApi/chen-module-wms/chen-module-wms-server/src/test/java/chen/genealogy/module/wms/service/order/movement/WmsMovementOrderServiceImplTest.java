package chen.genealogy.module.wms.service.order.movement;

import chen.genealogy.framework.test.core.ut.BaseDbUnitTest;
import chen.genealogy.module.wms.controller.admin.order.movement.vo.detail.WmsMovementOrderDetailSaveReqVO;
import chen.genealogy.module.wms.controller.admin.order.movement.vo.order.WmsMovementOrderSaveReqVO;
import chen.genealogy.module.wms.dal.dataobject.order.movement.WmsMovementOrderDO;
import chen.genealogy.module.wms.dal.dataobject.order.movement.WmsMovementOrderDetailDO;
import chen.genealogy.module.wms.dal.mysql.order.movement.WmsMovementOrderDetailMapper;
import chen.genealogy.module.wms.dal.mysql.order.movement.WmsMovementOrderMapper;
...
import static chen.genealogy.module.wms.enums.ErrorCodeConstants.MOVEMENT_ORDER_DETAIL_REQUIRED;
import static chen.genealogy.module.wms.enums.ErrorCodeConstants.MOVEMENT_ORDER_STATUS_NOT_DELETABLE;
import static chen.genealogy.module.wms.enums.ErrorCodeConstants.MOVEMENT_ORDER_STATUS_NOT_PREPARE;
import static chen.genealogy.module.wms.enums.ErrorCodeConstants.MOVEMENT_ORDER_WAREHOUSE_SAME;
