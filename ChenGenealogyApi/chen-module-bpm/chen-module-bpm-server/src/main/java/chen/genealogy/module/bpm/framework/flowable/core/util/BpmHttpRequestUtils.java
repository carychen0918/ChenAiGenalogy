...
import chen.genealogy.module.bpm.enums.definition.BpmHttpRequestParamTypeEnum;
...
import static chen.genealogy.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
import static chen.genealogy.module.bpm.enums.ErrorCodeConstants.PROCESS_INSTANCE_HTTP_CALL_ERROR;
