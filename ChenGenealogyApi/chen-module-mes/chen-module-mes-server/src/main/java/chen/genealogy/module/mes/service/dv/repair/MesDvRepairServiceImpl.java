package chen.genealogy.module.mes.service.dv.repair;
...
import chen.genealogy.module.mes.dal.mysql.dv.repair.MesDvRepairMapper;
import chen.genealogy.module.mes.enums.dv.MesDvRepairStatusEnum;
...
public class MesDvRepairServiceImpl implements MesDvRepairService {
    ...
    @Override
    public void confirmRepair(chen.genealogy.module.mes.controller.admin.dv.repair.vo.MesDvRepairConfirmReqVO confirmReqVO) {
        // 1. 校验存在，且状态为维修中
