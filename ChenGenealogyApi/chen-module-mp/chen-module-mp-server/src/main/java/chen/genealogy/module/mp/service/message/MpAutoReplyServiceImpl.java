...
import chen.genealogy.module.mp.controller.admin.message.vo.autoreply.MpAutoReplyCreateReqVO;
import chen.genealogy.module.mp.controller.admin.message.vo.autoreply.MpAutoReplyUpdateReqVO;
import chen.genealogy.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import chen.genealogy.module.mp.convert.message.MpAutoReplyConvert;
import chen.genealogy.module.mp.dal.dataobject.account.MpAccountDO;
import chen.genealogy.module.mp.dal.dataobject.message.MpAutoReplyDO;
import chen.genealogy.module.mp.dal.mysql.message.MpAutoReplyMapper;
import chen.genealogy.module.mp.enums.message.MpAutoReplyTypeEnum;
