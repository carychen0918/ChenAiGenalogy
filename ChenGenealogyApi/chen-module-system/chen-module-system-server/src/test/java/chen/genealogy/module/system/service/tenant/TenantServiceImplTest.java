package chen.genealogy.module.system.service.tenant;

import chen.genealogy.framework.common.enums.CommonStatusEnum;
import chen.genealogy.framework.common.pojo.PageResult;
import chen.genealogy.framework.tenant.config.TenantProperties;
import chen.genealogy.framework.tenant.core.context.TenantContextHolder;
import chen.genealogy.framework.test.core.ut.BaseDbUnitTest;
import chen.genealogy.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import chen.genealogy.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import chen.genealogy.module.system.dal.dataobject.permission.MenuDO;
...
import chen.genealogy.module.system.dal.dataobject.tenant.TenantPackageDO;
import chen.genealogy.module.system.dal.mysql.tenant.TenantMapper;
import chen.genealogy.module.system.enums.permission.RoleCodeEnum;
import chen.genealogy.module.system.enums.permission.RoleTypeEnum;
import chen.genealogy.module.system.service.permission.MenuService;
...
import chen.genealogy.module.system.service.tenant.handler.TenantInfoHandler;
import chen.genealogy.module.system.service.tenant.handler.TenantMenuHandler;
...
import static chen.genealogy.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
