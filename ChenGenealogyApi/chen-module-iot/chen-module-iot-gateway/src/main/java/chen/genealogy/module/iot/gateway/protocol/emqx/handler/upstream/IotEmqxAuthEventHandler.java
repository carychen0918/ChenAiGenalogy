package chen.genealogy.module.iot.gateway.protocol.emqx.handler.upstream;
...
import chen.genealogy.module.iot.gateway.protocol.emqx.IotEmqxProtocol;
    ...
    private void sendRegisterResultMessage(String username, IotDeviceRegisterRespDTO result) {
        ...
        try {
            ...
            byte[] encodedData = deviceMessageService.serializeDeviceMessage(responseMessage,
                    chen.genealogy.module.iot.core.enums.IotSerializeTypeEnum.JSON);
            // 1.3 构建响应主题
