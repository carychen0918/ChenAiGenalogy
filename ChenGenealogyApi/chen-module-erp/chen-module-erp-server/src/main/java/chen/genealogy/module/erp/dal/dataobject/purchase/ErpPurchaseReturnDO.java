package chen.genealogy.module.erp.dal.dataobject.purchase;
...
public class ErpPurchaseReturnDO extends BaseDO {
     ...
     * 退货状态
     *
     * 枚举 {@link chen.genealogy.module.erp.enums.ErpAuditStatus}
     */
     ...
     * 已退款金额，单位：元
     *
     * 目的：和 {@link chen.genealogy.module.erp.dal.dataobject.finance.ErpFinancePaymentDO} 结合，记录已支付金额
     */
