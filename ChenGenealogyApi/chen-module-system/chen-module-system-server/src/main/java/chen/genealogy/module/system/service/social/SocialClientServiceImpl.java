package chen.genealogy.module.system.service.social;
...
import chen.genealogy.framework.common.util.cache.CacheUtils;
import chen.genealogy.framework.common.util.http.HttpUtils;
import chen.genealogy.framework.common.util.object.BeanUtils;
import chen.genealogy.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import chen.genealogy.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import chen.genealogy.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import chen.genealogy.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import chen.genealogy.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import chen.genealogy.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import chen.genealogy.module.system.dal.dataobject.social.SocialClientDO;
import chen.genealogy.module.system.dal.mysql.social.SocialClientMapper;
import chen.genealogy.module.system.dal.redis.RedisKeyConstants;
import chen.genealogy.module.system.enums.social.SocialTypeEnum;
import chen.genealogy.module.system.framework.justauth.core.AuthRequestFactory;
...
import static chen.genealogy.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static chen.genealogy.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${chen.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${chen.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/chen-cloud/pulls/230
