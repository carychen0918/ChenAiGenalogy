package chen.genealogy.module.system.framework.captcha.config;

import chen.genealogy.module.system.framework.captcha.core.RedisCaptchaServiceImpl;
...
public class ChenCaptchaConfiguration {
