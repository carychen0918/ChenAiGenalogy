...
import chen.genealogy.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO;
import chen.genealogy.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLineSaveReqVO;
...
import chen.genealogy.module.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import chen.genealogy.module.mes.enums.qc.MesQcCheckResultEnum;
...
import chen.genealogy.module.mes.dal.dataobject.wm.salesnotice.MesWmSalesNoticeLineDO;
import chen.genealogy.module.mes.service.wm.salesnotice.MesWmSalesNoticeLineService;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public chen.genealogy.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return chen.genealogy.framework.common.pojo.PageResult.empty();
            }
