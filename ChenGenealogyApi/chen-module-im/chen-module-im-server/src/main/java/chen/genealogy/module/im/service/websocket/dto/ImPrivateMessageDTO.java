package chen.genealogy.module.im.service.websocket.dto;
...
import chen.genealogy.module.im.service.websocket.dto.notification.friend.BaseFriendNotification;
...
public class ImPrivateMessageDTO {
     ...
     * 与 {@link chen.genealogy.module.im.service.message.dto.ImGroupMessageSendDTO} 走 sendGroupMessage 群广播路径不同
     *
