package chen.genealogy.module.member.service.point;
...
import chen.genealogy.module.member.dal.mysql.point.MemberPointRecordMapper;
...
import static chen.genealogy.module.member.enums.ErrorCodeConstants.USER_POINT_NOT_ENOUGH;
