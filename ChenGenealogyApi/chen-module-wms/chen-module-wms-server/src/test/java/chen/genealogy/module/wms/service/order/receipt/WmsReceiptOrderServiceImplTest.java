package chen.genealogy.module.wms.service.order.receipt;

import chen.genealogy.framework.test.core.ut.BaseDbUnitTest;
import chen.genealogy.module.wms.controller.admin.order.receipt.vo.detail.WmsReceiptOrderDetailSaveReqVO;
import chen.genealogy.module.wms.controller.admin.order.receipt.vo.order.WmsReceiptOrderSaveReqVO;
import chen.genealogy.module.wms.dal.dataobject.order.receipt.WmsReceiptOrderDO;
import chen.genealogy.module.wms.dal.dataobject.order.receipt.WmsReceiptOrderDetailDO;
import chen.genealogy.module.wms.dal.mysql.order.receipt.WmsReceiptOrderDetailMapper;
import chen.genealogy.module.wms.dal.mysql.order.receipt.WmsReceiptOrderMapper;
...
import chen.genealogy.module.wms.enums.order.WmsReceiptOrderTypeEnum;
...
import static chen.genealogy.module.wms.enums.ErrorCodeConstants.RECEIPT_ORDER_DETAIL_REQUIRED;
import static chen.genealogy.module.wms.enums.ErrorCodeConstants.RECEIPT_ORDER_STATUS_NOT_PREPARE;
import static chen.genealogy.module.wms.enums.ErrorCodeConstants.RECEIPT_ORDER_STATUS_NOT_DELETABLE;
