package chen.genealogy.module.system.service.user;
...
import chen.genealogy.framework.common.util.collection.ArrayUtils;
import chen.genealogy.framework.common.util.collection.CollectionUtils;
import chen.genealogy.framework.test.core.ut.BaseDbUnitTest;
import chen.genealogy.module.infra.api.config.ConfigApi;
import chen.genealogy.module.infra.api.file.FileApi;
import chen.genealogy.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import chen.genealogy.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import chen.genealogy.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import chen.genealogy.module.system.controller.admin.user.vo.user.UserImportRespVO;
import chen.genealogy.module.system.controller.admin.user.vo.user.UserPageReqVO;
import chen.genealogy.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import chen.genealogy.module.system.dal.dataobject.dept.DeptDO;
import chen.genealogy.module.system.dal.dataobject.dept.PostDO;
import chen.genealogy.module.system.dal.dataobject.dept.UserPostDO;
...
import chen.genealogy.module.system.dal.mysql.dept.UserPostMapper;
import chen.genealogy.module.system.dal.mysql.user.AdminUserMapper;
import chen.genealogy.module.system.enums.common.SexEnum;
import chen.genealogy.module.system.mq.producer.user.AdminUserProducer;
import chen.genealogy.module.system.service.dept.DeptService;
import chen.genealogy.module.system.service.dept.PostService;
import chen.genealogy.module.system.service.oauth2.OAuth2TokenService;
import chen.genealogy.module.system.service.permission.PermissionService;
...
import static chen.genealogy.framework.common.util.collection.SetUtils.asSet;
import static chen.genealogy.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static chen.genealogy.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static chen.genealogy.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static chen.genealogy.framework.test.core.util.AssertUtils.assertPojoEquals;
import static chen.genealogy.framework.test.core.util.AssertUtils.assertServiceException;
import static chen.genealogy.framework.test.core.util.RandomUtils.*;
import static chen.genealogy.module.system.enums.ErrorCodeConstants.*;
import static chen.genealogy.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("chenyuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("chenyuanma");
        ...
        assertEquals("chenyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("chenyuanma"))).thenReturn("java");
