package chen.genealogy.module.system.api.user;
...
public class AdminUserApiImpl implements AdminUserApi {
    ...
    @Override
    @DataPermission(enable = false)
    public CommonResult<Long> createUser(AdminUserCreateReqDTO reqDTO) {
        UserSaveReqVO saveReqVO = BeanUtils.toBean(reqDTO, UserSaveReqVO.class);
        return success(userService.createUser(saveReqVO));
    }
