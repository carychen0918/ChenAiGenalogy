package chen.genealogy.module.member.controller.admin.level;

import chen.genealogy.framework.common.pojo.CommonResult;
import chen.genealogy.framework.common.pojo.PageResult;
import chen.genealogy.module.member.controller.admin.level.vo.experience.MemberExperienceRecordPageReqVO;
import chen.genealogy.module.member.controller.admin.level.vo.experience.MemberExperienceRecordRespVO;
import chen.genealogy.module.member.convert.level.MemberExperienceRecordConvert;
import chen.genealogy.module.member.dal.dataobject.level.MemberExperienceRecordDO;
import chen.genealogy.module.member.service.level.MemberExperienceRecordService;
