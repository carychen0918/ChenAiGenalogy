package chen.genealogy.module.infra.controller.admin.codegen;
...
import chen.genealogy.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import chen.genealogy.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import chen.genealogy.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import chen.genealogy.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import chen.genealogy.module.infra.convert.codegen.CodegenConvert;
...
import chen.genealogy.module.infra.service.codegen.CodegenService;
...
import static chen.genealogy.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "chen"),
