...
import chen.genealogy.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
import chen.genealogy.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import chen.genealogy.module.trade.convert.brokerage.BrokerageRecordConvert;
...
import chen.genealogy.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
...
import chen.genealogy.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
...
import static chen.genealogy.framework.common.util.collection.CollectionUtils.getMaxValue;
import static chen.genealogy.framework.common.util.collection.CollectionUtils.getMinValue;
import static chen.genealogy.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
