package chen.genealogy.module.wms.service.order.check;

import chen.genealogy.framework.test.core.ut.BaseDbUnitTest;
import chen.genealogy.module.wms.controller.admin.order.check.vo.detail.WmsCheckOrderDetailSaveReqVO;
import chen.genealogy.module.wms.controller.admin.order.check.vo.order.WmsCheckOrderSaveReqVO;
import chen.genealogy.module.wms.dal.dataobject.order.check.WmsCheckOrderDO;
import chen.genealogy.module.wms.dal.dataobject.order.check.WmsCheckOrderDetailDO;
import chen.genealogy.module.wms.dal.mysql.order.check.WmsCheckOrderDetailMapper;
import chen.genealogy.module.wms.dal.mysql.order.check.WmsCheckOrderMapper;
...
import chen.genealogy.module.wms.service.inventory.dto.WmsInventoryCheckReqDTO;
...
import static chen.genealogy.module.wms.enums.ErrorCodeConstants.CHECK_ORDER_DETAIL_REQUIRED;
import static chen.genealogy.module.wms.enums.ErrorCodeConstants.CHECK_ORDER_INVENTORY_CHANGED;
import static chen.genealogy.module.wms.enums.ErrorCodeConstants.CHECK_ORDER_STATUS_NOT_DELETABLE;
import static chen.genealogy.module.wms.enums.ErrorCodeConstants.CHECK_ORDER_STATUS_NOT_PREPARE;
