package chen.genealogy.module.iot.service.device;
...
import chen.genealogy.framework.common.util.validation.ValidationUtils;
import chen.genealogy.framework.tenant.core.aop.TenantIgnore;
import chen.genealogy.framework.tenant.core.util.TenantUtils;
import chen.genealogy.module.iot.controller.admin.device.vo.device.*;
import chen.genealogy.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import chen.genealogy.module.iot.core.biz.dto.IotSubDeviceRegisterFullReqDTO;
import chen.genealogy.module.iot.core.enums.IotDeviceMessageMethodEnum;
import chen.genealogy.module.iot.core.enums.device.IotDeviceStateEnum;
...
import chen.genealogy.module.iot.core.topic.auth.IotDeviceRegisterReqDTO;
import chen.genealogy.module.iot.core.topic.auth.IotDeviceRegisterRespDTO;
import chen.genealogy.module.iot.core.topic.auth.IotSubDeviceRegisterReqDTO;
import chen.genealogy.module.iot.core.topic.auth.IotSubDeviceRegisterRespDTO;
import chen.genealogy.module.iot.core.topic.topo.IotDeviceTopoAddReqDTO;
import chen.genealogy.module.iot.core.topic.topo.IotDeviceTopoChangeReqDTO;
import chen.genealogy.module.iot.core.topic.topo.IotDeviceTopoDeleteReqDTO;
import chen.genealogy.module.iot.core.topic.topo.IotDeviceTopoGetRespDTO;
import chen.genealogy.module.iot.core.util.IotDeviceAuthUtils;
import chen.genealogy.module.iot.core.util.IotProductAuthUtils;
import chen.genealogy.module.iot.dal.dataobject.device.IotDeviceDO;
import chen.genealogy.module.iot.dal.dataobject.device.IotDeviceGroupDO;
import chen.genealogy.module.iot.dal.dataobject.product.IotProductDO;
import chen.genealogy.module.iot.dal.mysql.device.IotDeviceMapper;
import chen.genealogy.module.iot.dal.redis.RedisKeyConstants;
import chen.genealogy.module.iot.enums.product.IotProductDeviceTypeEnum;
import chen.genealogy.module.iot.service.device.message.IotDeviceMessageService;
import chen.genealogy.module.iot.service.product.IotProductService;
...
import static chen.genealogy.module.iot.enums.ErrorCodeConstants.*;
