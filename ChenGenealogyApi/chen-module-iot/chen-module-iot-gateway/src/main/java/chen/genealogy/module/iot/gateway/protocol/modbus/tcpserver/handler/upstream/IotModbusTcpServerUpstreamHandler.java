package chen.genealogy.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import chen.genealogy.framework.common.exception.enums.GlobalErrorCodeConstants;
import chen.genealogy.framework.common.pojo.CommonResult;
import chen.genealogy.framework.common.util.json.JsonUtils;
import chen.genealogy.module.iot.core.biz.IotDeviceCommonApi;
import chen.genealogy.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import chen.genealogy.module.iot.core.biz.dto.IotDeviceRespDTO;
import chen.genealogy.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import chen.genealogy.module.iot.core.biz.dto.IotModbusPointRespDTO;
import chen.genealogy.module.iot.core.enums.IotDeviceMessageMethodEnum;
import chen.genealogy.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import chen.genealogy.module.iot.core.mq.message.IotDeviceMessage;
import chen.genealogy.module.iot.core.topic.IotDeviceIdentity;
import chen.genealogy.module.iot.core.util.IotDeviceAuthUtils;
import chen.genealogy.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import chen.genealogy.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import chen.genealogy.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import chen.genealogy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import chen.genealogy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import chen.genealogy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import chen.genealogy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import chen.genealogy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import chen.genealogy.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import chen.genealogy.module.iot.gateway.service.device.IotDeviceService;
import chen.genealogy.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static chen.genealogy.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static chen.genealogy.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static chen.genealogy.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link chen.genealogy.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
