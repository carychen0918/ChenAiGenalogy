package chen.genealogy.framework.web.config;
...
import chen.genealogy.framework.web.core.filter.CacheRequestBodyFilter;
import chen.genealogy.framework.web.core.filter.DemoFilter;
import chen.genealogy.framework.web.core.handler.GlobalExceptionHandler;
import chen.genealogy.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class ChenWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "chen.demo", havingValue = "true")
