package chen.genealogy.framework.ratelimiter.config;

import chen.genealogy.framework.ratelimiter.core.aop.RateLimiterAspect;
import chen.genealogy.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import chen.genealogy.framework.ratelimiter.core.keyresolver.impl.*;
import chen.genealogy.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class ChenRateLimiterConfiguration {
