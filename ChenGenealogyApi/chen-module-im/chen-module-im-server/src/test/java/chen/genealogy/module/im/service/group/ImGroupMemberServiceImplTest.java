...
import chen.genealogy.module.im.controller.admin.group.vo.member.ImGroupMemberUpdateReqVO;
import chen.genealogy.module.im.dal.dataobject.group.ImGroupMemberDO;
import chen.genealogy.module.im.dal.mysql.group.ImGroupMemberMapper;
...
import static chen.genealogy.module.im.enums.ErrorCodeConstants.GROUP_MEMBER_NOT_IN_GROUP;
...
public class ImGroupMemberServiceImplTest extends BaseMockitoUnitTest {
    ...
    @Mock
    private chen.genealogy.module.im.service.message.ImGroupMessageService groupMessageService;
    ...
    public void testUpdateGroupMember_success() {
        ...
        verify(groupMessageService).sendGroupMessage(eq(1L), any(chen.genealogy.module.im.service.message.dto.ImGroupMessageSendDTO.class));
        ...
        verify(groupMessageService).sendGroupMessage(eq(1L), eq(java.util.List.of(1L)),
                any(chen.genealogy.module.im.service.message.dto.ImGroupMessageSendDTO.class));
    }
