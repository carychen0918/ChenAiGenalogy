package chen.genealogy.module.iot.gateway.config;

import chen.genealogy.module.iot.core.enums.IotProtocolTypeEnum;
import chen.genealogy.module.iot.gateway.protocol.coap.IotCoapConfig;
import chen.genealogy.module.iot.gateway.protocol.emqx.IotEmqxConfig;
import chen.genealogy.module.iot.gateway.protocol.http.IotHttpConfig;
import chen.genealogy.module.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import chen.genealogy.module.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import chen.genealogy.module.iot.gateway.protocol.mqtt.IotMqttConfig;
import chen.genealogy.module.iot.gateway.protocol.tcp.IotTcpConfig;
import chen.genealogy.module.iot.gateway.protocol.udp.IotUdpConfig;
import chen.genealogy.module.iot.gateway.protocol.websocket.IotWebSocketConfig;
...
@ConfigurationProperties(prefix = "chen.iot.gateway")
@Validated
@Data
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see chen.genealogy.module.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see chen.genealogy.module.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
