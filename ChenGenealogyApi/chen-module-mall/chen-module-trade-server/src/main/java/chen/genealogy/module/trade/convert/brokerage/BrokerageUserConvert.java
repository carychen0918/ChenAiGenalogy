package chen.genealogy.module.trade.convert.brokerage;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.ObjUtil;
import chen.genealogy.framework.common.pojo.PageResult;
import chen.genealogy.module.member.api.user.dto.MemberUserRespDTO;
import chen.genealogy.module.trade.controller.admin.brokerage.vo.user.BrokerageUserRespVO;
import chen.genealogy.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserChildSummaryRespVO;
import chen.genealogy.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserMySummaryRespVO;
