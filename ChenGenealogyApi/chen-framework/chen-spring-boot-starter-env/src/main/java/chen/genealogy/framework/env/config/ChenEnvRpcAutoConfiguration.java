...
import chen.genealogy.framework.env.core.fegin.EnvLoadBalancerClientFactory;
import chen.genealogy.framework.env.core.fegin.EnvRequestInterceptor;
...
public class ChenEnvRpcAutoConfiguration {
