package chen.genealogy.module.member.convert.user;

import chen.genealogy.framework.common.pojo.PageResult;
import chen.genealogy.module.member.api.user.dto.MemberUserRespDTO;
import chen.genealogy.module.member.controller.admin.user.vo.MemberUserRespVO;
import chen.genealogy.module.member.controller.admin.user.vo.MemberUserUpdateReqVO;
import chen.genealogy.module.member.controller.app.user.vo.AppMemberUserInfoRespVO;
import chen.genealogy.module.member.convert.address.AddressConvert;
