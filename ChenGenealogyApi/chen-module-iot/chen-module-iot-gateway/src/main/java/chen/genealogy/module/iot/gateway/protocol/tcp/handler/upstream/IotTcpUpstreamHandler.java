package chen.genealogy.module.iot.gateway.protocol.tcp.handler.upstream;
...
import chen.genealogy.module.iot.gateway.protocol.tcp.codec.IotTcpFrameCodec;
import chen.genealogy.module.iot.gateway.protocol.tcp.manager.IotTcpConnectionManager;
import chen.genealogy.module.iot.gateway.serialize.IotMessageSerializer;
...
import static chen.genealogy.module.iot.gateway.enums.ErrorCodeConstants.DEVICE_AUTH_FAIL;
