package chen.genealogy.module.member.service.signin;
...
import chen.genealogy.module.member.controller.admin.signin.vo.record.MemberSignInRecordPageReqVO;
import chen.genealogy.module.member.controller.app.signin.vo.record.AppMemberSignInRecordSummaryRespVO;
import chen.genealogy.module.member.convert.signin.MemberSignInRecordConvert;
import chen.genealogy.module.member.dal.dataobject.signin.MemberSignInConfigDO;
import chen.genealogy.module.member.dal.dataobject.signin.MemberSignInRecordDO;
import chen.genealogy.module.member.dal.dataobject.user.MemberUserDO;
import chen.genealogy.module.member.dal.mysql.signin.MemberSignInRecordMapper;
import chen.genealogy.module.member.enums.MemberExperienceBizTypeEnum;
import chen.genealogy.module.member.enums.point.MemberPointBizTypeEnum;
import chen.genealogy.module.member.service.level.MemberLevelService;
import chen.genealogy.module.member.service.point.MemberPointRecordService;
import chen.genealogy.module.member.service.user.MemberUserService;
...
import static chen.genealogy.module.member.enums.ErrorCodeConstants.SIGN_IN_RECORD_TODAY_EXISTS;
