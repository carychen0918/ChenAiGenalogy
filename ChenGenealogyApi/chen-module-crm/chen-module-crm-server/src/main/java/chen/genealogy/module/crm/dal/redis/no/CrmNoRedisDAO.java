package chen.genealogy.module.crm.dal.redis.no;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.DateUtil;
import chen.genealogy.module.crm.dal.redis.RedisKeyConstants;
...
public class CrmNoRedisDAO {
    ...
    /**
     * 合同 {@link chen.genealogy.module.crm.dal.dataobject.contract.CrmContractDO}
     */
    public static final String CONTRACT_NO_PREFIX = "HT";

    /**
     * 回款 {@link chen.genealogy.module.crm.dal.dataobject.receivable.CrmReceivablePlanDO}
     */
