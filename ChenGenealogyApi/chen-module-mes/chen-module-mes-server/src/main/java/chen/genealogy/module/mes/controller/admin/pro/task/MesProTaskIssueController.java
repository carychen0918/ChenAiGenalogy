...
import chen.genealogy.module.mes.controller.admin.pro.task.vo.MesProTaskIssuePageReqVO;
import chen.genealogy.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import chen.genealogy.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
import chen.genealogy.module.mes.dal.dataobject.pro.task.MesProTaskIssueDO;
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return chen.genealogy.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
