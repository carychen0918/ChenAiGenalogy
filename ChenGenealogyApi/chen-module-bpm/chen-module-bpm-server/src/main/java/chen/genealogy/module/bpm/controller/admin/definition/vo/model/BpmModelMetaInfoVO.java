package chen.genealogy.module.bpm.controller.admin.definition.vo.model;
...
import chen.genealogy.module.bpm.enums.definition.BpmAutoApproveTypeEnum;
 ...
 *
 * 最终，它的字段和
 * {@link chen.genealogy.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO}
 * 是一致的
 *
 * @author 芋道源码
 */
...
public class BpmModelMetaInfoVO {
    ...
    @Schema(description = "流程图标", example = "https://www.iocoder.cn/chen.jpg")
