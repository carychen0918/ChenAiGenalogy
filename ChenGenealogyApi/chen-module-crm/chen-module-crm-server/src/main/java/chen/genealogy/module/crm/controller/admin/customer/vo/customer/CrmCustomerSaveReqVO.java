package chen.genealogy.module.crm.controller.admin.customer.vo.customer;

import chen.genealogy.framework.common.validation.InEnum;
import chen.genealogy.framework.common.validation.Mobile;
import chen.genealogy.framework.common.validation.Telephone;
import chen.genealogy.framework.excel.core.annotations.DictFormat;
import chen.genealogy.module.crm.enums.customer.CrmCustomerLevelEnum;
import chen.genealogy.module.crm.framework.operatelog.core.CrmCustomerIndustryParseFunction;
import chen.genealogy.module.crm.framework.operatelog.core.CrmCustomerLevelParseFunction;
import chen.genealogy.module.crm.framework.operatelog.core.CrmCustomerSourceParseFunction;
import chen.genealogy.module.crm.framework.operatelog.core.SysAreaParseFunction;
...
import static chen.genealogy.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_INDUSTRY;
