package chen.genealogy.module.iot.api.device;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import chen.genealogy.framework.common.enums.RpcConstants;
...
import chen.genealogy.module.iot.core.biz.dto.*;
...
import chen.genealogy.module.iot.dal.dataobject.device.IotDeviceModbusConfigDO;
import chen.genealogy.module.iot.dal.dataobject.device.IotDeviceModbusPointDO;
import chen.genealogy.module.iot.dal.dataobject.product.IotProductDO;
import chen.genealogy.module.iot.service.device.IotDeviceModbusConfigService;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 chen-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
