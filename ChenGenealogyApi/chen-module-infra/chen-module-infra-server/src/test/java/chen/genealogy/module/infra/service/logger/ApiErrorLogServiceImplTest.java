package chen.genealogy.module.infra.service.logger;
...
import chen.genealogy.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import chen.genealogy.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import chen.genealogy.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import chen.genealogy.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static chen.genealogy.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static chen.genealogy.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("chen-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("chen-test");
