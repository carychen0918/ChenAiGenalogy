package chen.genealogy.module.iot.service.device.property;
...
import chen.genealogy.module.iot.controller.admin.device.vo.property.IotDevicePropertyHistoryListReqVO;
import chen.genealogy.module.iot.controller.admin.device.vo.property.IotDevicePropertyRespVO;
...
import chen.genealogy.module.iot.dal.dataobject.device.IotDevicePropertyDO;
import chen.genealogy.module.iot.dal.dataobject.product.IotProductDO;
import chen.genealogy.module.iot.dal.dataobject.thingmodel.IotThingModelDO;
import chen.genealogy.module.iot.dal.dataobject.thingmodel.model.dataType.ThingModelDateOrTextDataSpecs;
import chen.genealogy.module.iot.dal.redis.device.DevicePropertyRedisDAO;
import chen.genealogy.module.iot.dal.redis.device.DeviceReportTimeRedisDAO;
import chen.genealogy.module.iot.dal.redis.device.DeviceServerIdRedisDAO;
import chen.genealogy.module.iot.dal.tdengine.IotDevicePropertyMapper;
import chen.genealogy.module.iot.enums.thingmodel.IotDataSpecsDataTypeEnum;
import chen.genealogy.module.iot.enums.thingmodel.IotThingModelTypeEnum;
import chen.genealogy.module.iot.framework.tdengine.core.TDengineTableField;
...
import chen.genealogy.module.iot.service.thingmodel.IotThingModelService;
...
import static chen.genealogy.framework.common.util.collection.MapUtils.getBigDecimal;
