package chen.genealogy.framework.tracer.config;

import chen.genealogy.framework.common.enums.WebFilterOrderEnum;
import chen.genealogy.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "chen.tracer", value = "enable", matchIfMissing = true)
public class ChenTracerAutoConfiguration {
