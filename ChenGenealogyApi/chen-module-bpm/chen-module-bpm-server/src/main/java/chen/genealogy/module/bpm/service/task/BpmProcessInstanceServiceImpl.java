package chen.genealogy.module.bpm.service.task;
...
import chen.genealogy.framework.common.util.date.DateUtils;
import chen.genealogy.framework.common.util.json.JsonUtils;
import chen.genealogy.framework.common.util.object.ObjectUtils;
import chen.genealogy.framework.common.util.object.PageUtils;
import chen.genealogy.framework.datapermission.core.annotation.DataPermission;
import chen.genealogy.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import chen.genealogy.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import chen.genealogy.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import chen.genealogy.module.bpm.controller.admin.task.vo.instance.*;
import chen.genealogy.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import chen.genealogy.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import chen.genealogy.module.bpm.convert.task.BpmProcessInstanceConvert;
import chen.genealogy.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import chen.genealogy.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import chen.genealogy.module.bpm.enums.ErrorCodeConstants;
import chen.genealogy.module.bpm.enums.definition.BpmModelTypeEnum;
import chen.genealogy.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import chen.genealogy.module.bpm.enums.task.BpmAttachmentTypeEnum;
import chen.genealogy.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import chen.genealogy.module.bpm.enums.task.BpmReasonEnum;
import chen.genealogy.module.bpm.enums.task.BpmTaskStatusEnum;
import chen.genealogy.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import chen.genealogy.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import chen.genealogy.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import chen.genealogy.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import chen.genealogy.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import chen.genealogy.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import chen.genealogy.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import chen.genealogy.module.bpm.framework.flowable.core.util.FlowableUtils;
import chen.genealogy.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import chen.genealogy.module.bpm.service.definition.BpmProcessDefinitionService;
import chen.genealogy.module.bpm.service.message.BpmMessageService;
...
import static chen.genealogy.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static chen.genealogy.module.bpm.enums.ErrorCodeConstants.*;
import static chen.genealogy.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static chen.genealogy.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/chen-cloud/issues/ID1UYA
