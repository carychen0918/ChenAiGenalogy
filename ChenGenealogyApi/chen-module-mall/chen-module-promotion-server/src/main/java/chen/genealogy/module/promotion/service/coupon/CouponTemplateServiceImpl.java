package chen.genealogy.module.promotion.service.coupon;
...
import chen.genealogy.module.promotion.controller.admin.coupon.vo.template.CouponTemplateCreateReqVO;
import chen.genealogy.module.promotion.controller.admin.coupon.vo.template.CouponTemplatePageReqVO;
import chen.genealogy.module.promotion.controller.admin.coupon.vo.template.CouponTemplateUpdateReqVO;
import chen.genealogy.module.promotion.convert.coupon.CouponTemplateConvert;
import chen.genealogy.module.promotion.dal.dataobject.coupon.CouponTemplateDO;
import chen.genealogy.module.promotion.dal.mysql.coupon.CouponTemplateMapper;
import chen.genealogy.module.promotion.enums.common.PromotionProductScopeEnum;
import chen.genealogy.module.promotion.enums.coupon.CouponTakeTypeEnum;
...
public class CouponTemplateServiceImpl implements CouponTemplateService {
    ...
    private void validateTotalCountNotLessThanTakeLimitCount(Integer takeType, Integer totalCount, Integer takeLimitCount) {
        // 修复 https://gitee.com/chencode/chen-mall-uniapp/issues/IJLP6Q 反馈
