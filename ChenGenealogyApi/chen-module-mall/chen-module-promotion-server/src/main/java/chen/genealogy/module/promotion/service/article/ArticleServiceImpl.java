package chen.genealogy.module.promotion.service.article;

import cn.hutool.core.collection.CollUtil;
import chen.genealogy.framework.common.pojo.PageResult;
import chen.genealogy.module.promotion.controller.admin.article.vo.article.ArticleCreateReqVO;
import chen.genealogy.module.promotion.controller.admin.article.vo.article.ArticlePageReqVO;
import chen.genealogy.module.promotion.controller.admin.article.vo.article.ArticleUpdateReqVO;
import chen.genealogy.module.promotion.controller.app.article.vo.article.AppArticlePageReqVO;
import chen.genealogy.module.promotion.convert.article.ArticleConvert;
import chen.genealogy.module.promotion.dal.dataobject.article.ArticleCategoryDO;
import chen.genealogy.module.promotion.dal.dataobject.article.ArticleDO;
import chen.genealogy.module.promotion.dal.mysql.article.ArticleMapper;
...
import static chen.genealogy.module.promotion.enums.ErrorCodeConstants.ARTICLE_CATEGORY_NOT_EXISTS;
import static chen.genealogy.module.promotion.enums.ErrorCodeConstants.ARTICLE_NOT_EXISTS;
