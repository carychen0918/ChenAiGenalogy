...
import chen.genealogy.module.promotion.controller.admin.article.vo.category.ArticleCategoryCreateReqVO;
import chen.genealogy.module.promotion.controller.admin.article.vo.category.ArticleCategoryPageReqVO;
import chen.genealogy.module.promotion.controller.admin.article.vo.category.ArticleCategoryUpdateReqVO;
import chen.genealogy.module.promotion.convert.article.ArticleCategoryConvert;
import chen.genealogy.module.promotion.dal.dataobject.article.ArticleCategoryDO;
import chen.genealogy.module.promotion.dal.mysql.article.ArticleCategoryMapper;
...
import static chen.genealogy.module.promotion.enums.ErrorCodeConstants.ARTICLE_CATEGORY_DELETE_FAIL_HAVE_ARTICLES;
