...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "chen.genealogy";
    private static final String ARTIFACT_ID = "chen";
    private static final String PACKAGE_NAME = "chen.genealogy";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "chen.genealogy";
        String artifactIdNew = "chen";
        String packageNameNew = "chen.genealogy";
