package chen.genealogy.module.member.controller.admin.config;

import chen.genealogy.framework.common.pojo.CommonResult;
import chen.genealogy.module.member.controller.admin.config.vo.MemberConfigRespVO;
import chen.genealogy.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import chen.genealogy.module.member.convert.config.MemberConfigConvert;
import chen.genealogy.module.member.dal.dataobject.config.MemberConfigDO;
import chen.genealogy.module.member.service.config.MemberConfigService;
