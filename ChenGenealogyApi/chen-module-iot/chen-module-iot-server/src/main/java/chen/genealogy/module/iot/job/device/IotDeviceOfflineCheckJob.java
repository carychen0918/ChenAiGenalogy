package chen.genealogy.module.iot.job.device;
...
import chen.genealogy.module.iot.framework.iot.config.ChenIotProperties;
...
public class IotDeviceOfflineCheckJob {
    ...
    @Resource
    private ChenIotProperties iotProperties;
