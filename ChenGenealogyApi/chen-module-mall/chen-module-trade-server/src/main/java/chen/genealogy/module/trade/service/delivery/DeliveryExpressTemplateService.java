...
import chen.genealogy.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateCreateReqVO;
import chen.genealogy.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateDetailRespVO;
import chen.genealogy.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplatePageReqVO;
import chen.genealogy.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateUpdateReqVO;
...
public interface DeliveryExpressTemplateService {
     ...
     * 校验快递运费模板
     *
     * 如果校验不通过，抛出 {@link chen.genealogy.framework.common.exception.ServiceException} 异常
     *
