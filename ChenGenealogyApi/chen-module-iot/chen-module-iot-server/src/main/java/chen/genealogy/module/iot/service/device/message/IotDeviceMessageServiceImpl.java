package chen.genealogy.module.iot.service.device.message;
...
import chen.genealogy.module.iot.controller.admin.device.vo.message.IotDeviceMessagePageReqVO;
import chen.genealogy.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageReqVO;
import chen.genealogy.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageSummaryByDateRespVO;
...
import chen.genealogy.module.iot.core.mq.producer.IotDeviceMessageProducer;
import chen.genealogy.module.iot.core.topic.IotDeviceIdentity;
import chen.genealogy.module.iot.core.topic.event.IotDeviceEventPostReqDTO;
import chen.genealogy.module.iot.core.topic.property.IotDevicePropertyPackPostReqDTO;
import chen.genealogy.module.iot.core.topic.property.IotDevicePropertyPostReqDTO;
...
import chen.genealogy.module.iot.dal.dataobject.device.IotDeviceMessageDO;
import chen.genealogy.module.iot.dal.tdengine.IotDeviceMessageMapper;
import chen.genealogy.module.iot.service.device.IotDeviceService;
import chen.genealogy.module.iot.service.device.property.IotDevicePropertyService;
import chen.genealogy.module.iot.service.ota.IotOtaTaskRecordService;
...
import static chen.genealogy.module.iot.enums.ErrorCodeConstants.DEVICE_DOWNSTREAM_FAILED_SERVER_ID_NULL;
