...
import chen.genealogy.module.member.api.user.dto.MemberUserRespDTO;
...
import chen.genealogy.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import chen.genealogy.module.product.api.sku.dto.ProductSkuRespDTO;
import chen.genealogy.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import chen.genealogy.module.product.api.spu.dto.ProductSpuRespDTO;
import chen.genealogy.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import chen.genealogy.module.trade.api.order.dto.TradeOrderRespDTO;
import chen.genealogy.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import chen.genealogy.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import chen.genealogy.module.trade.controller.admin.order.vo.*;
import chen.genealogy.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import chen.genealogy.module.trade.controller.app.order.vo.*;
import chen.genealogy.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import chen.genealogy.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import chen.genealogy.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import chen.genealogy.module.trade.framework.order.config.TradeOrderProperties;
import chen.genealogy.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static chen.genealogy.framework.common.util.collection.CollectionUtils.convertMap;
import static chen.genealogy.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static chen.genealogy.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/chencode/chen-mall-uniapp/issues/ICY7SJ
