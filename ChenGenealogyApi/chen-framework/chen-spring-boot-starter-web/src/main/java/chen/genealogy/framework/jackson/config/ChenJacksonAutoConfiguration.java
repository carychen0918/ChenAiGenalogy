package chen.genealogy.framework.jackson.config;

import chen.genealogy.framework.common.util.json.JsonUtils;
import chen.genealogy.framework.common.util.json.databind.NumberSerializer;
import chen.genealogy.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import chen.genealogy.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class ChenJacksonAutoConfiguration {
