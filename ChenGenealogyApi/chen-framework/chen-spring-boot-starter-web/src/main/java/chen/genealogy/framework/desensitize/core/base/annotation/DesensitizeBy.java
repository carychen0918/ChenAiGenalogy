package chen.genealogy.framework.desensitize.core.base.annotation;

import chen.genealogy.framework.desensitize.core.base.handler.DesensitizationHandler;
import chen.genealogy.framework.desensitize.core.base.serializer.StringDesensitizeSerializer;
