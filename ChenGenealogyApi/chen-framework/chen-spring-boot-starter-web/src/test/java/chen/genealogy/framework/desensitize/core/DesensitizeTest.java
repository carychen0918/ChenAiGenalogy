package chen.genealogy.framework.desensitize.core;

import chen.genealogy.framework.common.util.json.JsonUtils;
import chen.genealogy.framework.desensitize.core.regex.annotation.EmailDesensitize;
import chen.genealogy.framework.desensitize.core.regex.annotation.RegexDesensitize;
import chen.genealogy.framework.desensitize.core.annotation.Address;
import chen.genealogy.framework.desensitize.core.slider.annotation.BankCardDesensitize;
import chen.genealogy.framework.desensitize.core.slider.annotation.CarLicenseDesensitize;
import chen.genealogy.framework.desensitize.core.slider.annotation.ChineseNameDesensitize;
import chen.genealogy.framework.desensitize.core.slider.annotation.FixedPhoneDesensitize;
import chen.genealogy.framework.desensitize.core.slider.annotation.IdCardDesensitize;
import chen.genealogy.framework.desensitize.core.slider.annotation.PasswordDesensitize;
import chen.genealogy.framework.desensitize.core.slider.annotation.MobileDesensitize;
import chen.genealogy.framework.desensitize.core.slider.annotation.SliderDesensitize;
import lombok.Data;
