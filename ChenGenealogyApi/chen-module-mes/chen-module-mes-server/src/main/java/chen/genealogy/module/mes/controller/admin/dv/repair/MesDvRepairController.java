package chen.genealogy.module.mes.controller.admin.dv.repair;
...
import chen.genealogy.module.mes.controller.admin.dv.repair.vo.MesDvRepairPageReqVO;
import chen.genealogy.module.mes.controller.admin.dv.repair.vo.MesDvRepairRespVO;
import chen.genealogy.module.mes.controller.admin.dv.repair.vo.MesDvRepairSaveReqVO;
import chen.genealogy.module.mes.dal.dataobject.dv.machinery.MesDvMachineryDO;
import chen.genealogy.module.mes.dal.dataobject.dv.repair.MesDvRepairDO;
...
public class MesDvRepairController {
    ...
    @PreAuthorize("@ss.hasPermission('mes:dv-repair:update')")
    public CommonResult<Boolean> confirmRepair(@Valid @RequestBody chen.genealogy.module.mes.controller.admin.dv.repair.vo.MesDvRepairConfirmReqVO confirmReqVO) {
