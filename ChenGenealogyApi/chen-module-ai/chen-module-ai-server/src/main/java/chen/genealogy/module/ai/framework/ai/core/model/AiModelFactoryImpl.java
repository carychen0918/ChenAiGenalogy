package chen.genealogy.module.ai.framework.ai.core.model;
...
import chen.genealogy.framework.common.util.spring.SpringUtils;
import chen.genealogy.module.ai.enums.model.AiPlatformEnum;
import chen.genealogy.module.ai.framework.ai.config.AiAutoConfiguration;
import chen.genealogy.module.ai.framework.ai.config.ChenAiProperties;
...
import chen.genealogy.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import chen.genealogy.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            ChenAiProperties.Midjourney properties = SpringUtil.getBean(ChenAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(ChenAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        ChenAiProperties.DouBao properties = new ChenAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(ChenAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        ChenAiProperties.HunYuan properties = new ChenAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(ChenAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        ChenAiProperties.SiliconFlow properties = new ChenAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(ChenAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        ChenAiProperties.XingHuo properties = new ChenAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(ChenAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        ChenAiProperties.BaiChuan properties = new ChenAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(ChenAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        ChenAiProperties.Gemini properties = SpringUtil.getBean(ChenAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        ChenAiProperties.Grok properties = new ChenAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
