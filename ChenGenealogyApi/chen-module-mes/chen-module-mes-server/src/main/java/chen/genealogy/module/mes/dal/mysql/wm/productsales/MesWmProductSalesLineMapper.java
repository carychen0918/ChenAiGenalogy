package chen.genealogy.module.mes.dal.mysql.wm.productsales;
...
public interface MesWmProductSalesLineMapper extends BaseMapperX<MesWmProductSalesLineDO> {
    ...
    default chen.genealogy.framework.common.pojo.PageResult<MesWmProductSalesLineDO> selectPage(
            chen.genealogy.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO reqVO) {
        return selectPage(reqVO, new chen.genealogy.framework.mybatis.core.query.LambdaQueryWrapperX<MesWmProductSalesLineDO>()
