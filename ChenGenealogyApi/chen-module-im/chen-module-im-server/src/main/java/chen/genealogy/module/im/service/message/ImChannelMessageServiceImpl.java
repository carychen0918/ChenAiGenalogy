...
import chen.genealogy.module.im.controller.admin.manager.message.vo.channel.ImChannelMessagePageReqVO;
import chen.genealogy.module.im.controller.admin.manager.message.vo.channel.ImChannelMessageSendReqVO;
import chen.genealogy.module.im.dal.dataobject.channel.ImChannelMaterialDO;
import chen.genealogy.module.im.dal.dataobject.message.ImChannelMessageDO;
import chen.genealogy.module.im.dal.mysql.message.ImChannelMessageMapper;
import chen.genealogy.module.im.dal.redis.message.ImChannelMessageReadRedisDAO;
import chen.genealogy.module.im.enums.message.ImMessageTypeEnum;
import chen.genealogy.module.im.service.channel.ImChannelMaterialService;
import chen.genealogy.module.im.service.websocket.ImWebSocketService;
import chen.genealogy.module.im.service.websocket.dto.ImChannelMessageDTO;
import chen.genealogy.module.im.service.websocket.dto.message.MaterialMessage;
...
import static chen.genealogy.module.im.enums.ErrorCodeConstants.IM_CHANNEL_MESSAGE_NOT_EXISTS;
