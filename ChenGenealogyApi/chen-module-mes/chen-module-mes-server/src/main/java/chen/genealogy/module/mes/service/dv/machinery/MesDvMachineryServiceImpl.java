package chen.genealogy.module.mes.service.dv.machinery;
...
import chen.genealogy.module.mes.controller.admin.dv.machinery.vo.MesDvMachineryImportExcelVO;
import chen.genealogy.module.mes.controller.admin.dv.machinery.vo.MesDvMachineryImportRespVO;
import chen.genealogy.module.mes.controller.admin.dv.machinery.vo.MesDvMachineryPageReqVO;
import chen.genealogy.module.mes.controller.admin.dv.machinery.vo.MesDvMachinerySaveReqVO;
import chen.genealogy.module.mes.dal.dataobject.dv.machinery.MesDvMachineryDO;
import chen.genealogy.module.mes.dal.dataobject.dv.machinery.MesDvMachineryTypeDO;
import chen.genealogy.module.mes.dal.dataobject.md.workstation.MesMdWorkshopDO;
import chen.genealogy.module.mes.dal.mysql.dv.machinery.MesDvMachineryMapper;
import chen.genealogy.module.mes.enums.wm.BarcodeBizTypeEnum;
import chen.genealogy.module.mes.service.dv.checkplan.MesDvCheckPlanMachineryService;
import chen.genealogy.module.mes.service.dv.checkrecord.MesDvCheckRecordService;
import chen.genealogy.module.mes.service.dv.maintenrecord.MesDvMaintenRecordService;
import chen.genealogy.module.mes.service.dv.repair.MesDvRepairService;
import chen.genealogy.module.mes.service.md.workstation.MesMdWorkshopService;
...
public class MesDvMachineryServiceImpl implements MesDvMachineryService {
    ...
    public MesDvMachineryImportRespVO importMachineryList(List<MesDvMachineryImportExcelVO> importMachineryList,
        ...
        List<MesDvMachineryTypeDO> allTypes = machineryTypeService.getMachineryTypeList(
                new chen.genealogy.module.mes.controller.admin.dv.machinery.vo.type.MesDvMachineryTypeListReqVO());
        ...
        List<MesMdWorkshopDO> allWorkshops = workshopService.getWorkshopListByStatus(
                chen.genealogy.framework.common.enums.CommonStatusEnum.ENABLE.getStatus());
