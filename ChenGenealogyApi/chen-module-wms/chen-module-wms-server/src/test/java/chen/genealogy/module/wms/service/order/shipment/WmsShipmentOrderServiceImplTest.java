package chen.genealogy.module.wms.service.order.shipment;

import chen.genealogy.framework.test.core.ut.BaseDbUnitTest;
import chen.genealogy.module.wms.controller.admin.order.shipment.vo.detail.WmsShipmentOrderDetailSaveReqVO;
import chen.genealogy.module.wms.controller.admin.order.shipment.vo.order.WmsShipmentOrderSaveReqVO;
import chen.genealogy.module.wms.dal.dataobject.order.shipment.WmsShipmentOrderDO;
import chen.genealogy.module.wms.dal.dataobject.order.shipment.WmsShipmentOrderDetailDO;
import chen.genealogy.module.wms.dal.mysql.order.shipment.WmsShipmentOrderDetailMapper;
import chen.genealogy.module.wms.dal.mysql.order.shipment.WmsShipmentOrderMapper;
import chen.genealogy.module.wms.enums.order.WmsOrderTypeEnum;
import chen.genealogy.module.wms.enums.order.WmsOrderStatusEnum;
import chen.genealogy.module.wms.enums.order.WmsShipmentOrderTypeEnum;
import chen.genealogy.module.wms.service.inventory.WmsInventoryService;
import chen.genealogy.module.wms.service.inventory.dto.WmsInventoryChangeReqDTO;
import chen.genealogy.module.wms.service.md.item.WmsItemSkuService;
import chen.genealogy.module.wms.service.md.merchant.WmsMerchantService;
import chen.genealogy.module.wms.service.md.warehouse.WmsWarehouseService;
...
import static chen.genealogy.module.wms.enums.ErrorCodeConstants.SHIPMENT_ORDER_DETAIL_REQUIRED;
import static chen.genealogy.module.wms.enums.ErrorCodeConstants.SHIPMENT_ORDER_STATUS_NOT_DELETABLE;
import static chen.genealogy.module.wms.enums.ErrorCodeConstants.SHIPMENT_ORDER_STATUS_NOT_PREPARE;
