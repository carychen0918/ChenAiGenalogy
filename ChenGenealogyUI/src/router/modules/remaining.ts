...
const remainingRouter: AppRouteRecordRaw[] = [
  ...
  {
    path: '/login',
    component: () => import('@/views/genealogy/auth/GenealogyLogin.vue'),
    name: 'Login',
    meta: {
      hidden: true,
      title: '族人登录',
  ...
  {
    path: '/portal',
    component: () => import('@/views/genealogy/portal/layout.vue'),
    name: 'GenealogyPortal',
    redirect: '/portal/home',
    meta: { hidden: true, title: '族人端', canTo: true, noTagsView: true },
    children: [
      {
        path: 'home',
        component: () => import('@/views/genealogy/portal/home.vue'),
        name: 'PortalHome',
      ...
      },
      {
        ...
        name: 'PortalMember',
        meta: { hidden: true, canTo: true, title: '成员详情', noTagsView: true, requiresAuth: true }
      },
      {
        path: 'roots',
        component: () => import('@/views/genealogy/portal/roots.vue'),
        name: 'PortalRoots',
        meta: { hidden: true, canTo: true, title: '寻根问祖', noTagsView: true }
      },
      {
        path: 'ai-match',
        component: () => import('@/views/genealogy/portal/ai-match.vue'),
        name: 'PortalAiMatch',
        meta: { hidden: true, canTo: true, title: 'AI寻宗问祖', noTagsView: true }
      },
      {
        path: 'migration',
        component: () => import('@/views/genealogy/portal/migration.vue'),
        name: 'PortalMigration',
        meta: { hidden: true, canTo: true, title: '姓氏源流与迁徙', noTagsView: true }
      },
      {
        path: 'generation',
        component: () => import('@/views/genealogy/portal/generation.vue'),
        name: 'PortalGeneration',
        meta: { hidden: true, canTo: true, title: '字辈派语', noTagsView: true }
      },
      {
        path: 'achievements',
        component: () => import('@/views/genealogy/portal/achievements.vue'),
        name: 'PortalAchievements',
        meta: { hidden: true, canTo: true, title: '祖先事迹', noTagsView: true }
      },
      {
        path: 'scholarship',
        component: () => import('@/views/genealogy/portal/scholarship.vue'),
        name: 'PortalScholarship',
        meta: { hidden: true, canTo: true, title: '学海无涯', noTagsView: true, requiresAuth: true }
      },
      {
        path: 'scholarship-apply',
        component: () => import('@/views/genealogy/portal/scholarship-apply.vue'),
        name: 'PortalScholarshipApply',
        meta: { hidden: true, canTo: true, title: '资助申请', noTagsView: true, requiresAuth: true }
      },
      {
        path: 'my-applications',
        component: () => import('@/views/genealogy/portal/my-applications.vue'),
        name: 'PortalMyApplications',
        meta: { hidden: true, canTo: true, title: '我的申请', noTagsView: true, requiresAuth: true }
      },
      {
        path: 'ancestor',
        component: () => import('@/views/genealogy/portal/ancestor.vue'),
        name: 'PortalAncestor',
        meta: { hidden: true, canTo: true, title: '清明祭祖', noTagsView: true, requiresAuth: true }
      },
      {
        path: 'activity',
        component: () => import('@/views/genealogy/portal/activity.vue'),
        name: 'PortalActivity',
        meta: { hidden: true, canTo: true, title: '祭祖活动详情', noTagsView: true, requiresAuth: true }
      },
      {
        path: 'nav',
        component: () => import('@/views/genealogy/portal/nav.vue'),
        name: 'PortalNav',
      ...
      },
      {
        ...
        name: 'PortalProfile',
        meta: { hidden: true, canTo: true, title: '个人中心', noTagsView: true, requiresAuth: true }
      }
    ]
  }
]
