package chen.genealogy.module.trade.service.brokerage;
...
import chen.genealogy.module.trade.controller.admin.brokerage.vo.user.BrokerageUserCreateReqVO;
import chen.genealogy.module.trade.controller.admin.brokerage.vo.user.BrokerageUserPageReqVO;
import chen.genealogy.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserChildSummaryPageReqVO;
import chen.genealogy.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserChildSummaryRespVO;
import chen.genealogy.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByUserCountRespVO;
import chen.genealogy.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import chen.genealogy.module.trade.convert.brokerage.BrokerageUserConvert;
import chen.genealogy.module.trade.dal.dataobject.brokerage.BrokerageUserDO;
import chen.genealogy.module.trade.dal.dataobject.config.TradeConfigDO;
import chen.genealogy.module.trade.dal.mysql.brokerage.BrokerageUserMapper;
import chen.genealogy.module.trade.enums.brokerage.BrokerageBindModeEnum;
import chen.genealogy.module.trade.enums.brokerage.BrokerageEnabledConditionEnum;
import chen.genealogy.module.trade.enums.brokerage.BrokerageRecordBizTypeEnum;
import chen.genealogy.module.trade.enums.brokerage.BrokerageRecordStatusEnum;
...
import static chen.genealogy.framework.common.util.collection.CollectionUtils.convertMapByFilter;
