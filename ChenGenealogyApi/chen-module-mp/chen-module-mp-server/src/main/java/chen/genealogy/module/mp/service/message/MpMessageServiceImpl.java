package chen.genealogy.module.mp.service.message;
...
import chen.genealogy.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import chen.genealogy.module.mp.convert.message.MpMessageConvert;
...
import chen.genealogy.module.mp.dal.mysql.message.MpMessageMapper;
import chen.genealogy.module.mp.enums.message.MpMessageSendFromEnum;
import chen.genealogy.module.mp.framework.mp.core.MpServiceFactory;
import chen.genealogy.module.mp.framework.mp.core.util.MpUtils;
import chen.genealogy.module.mp.service.account.MpAccountService;
import chen.genealogy.module.mp.service.material.MpMaterialService;
import chen.genealogy.module.mp.service.message.bo.MpMessageSendOutReqBO;
import chen.genealogy.module.mp.service.user.MpUserService;
...
import static chen.genealogy.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
