package chen.genealogy.module.mp.service.account;
...
import chen.genealogy.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import chen.genealogy.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import chen.genealogy.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import chen.genealogy.module.mp.convert.account.MpAccountConvert;
import chen.genealogy.module.mp.dal.dataobject.account.MpAccountDO;
import chen.genealogy.module.mp.dal.mysql.account.MpAccountMapper;
import chen.genealogy.module.mp.enums.ErrorCodeConstants;
import chen.genealogy.module.mp.framework.mp.core.MpServiceFactory;
...
import static chen.genealogy.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 chen-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
