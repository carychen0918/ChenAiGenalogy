...
CREATE TABLE `tb_generation` (
  ...
  `national_source` varchar(16) DEFAULT NULL COMMENT '全国统一字派',
  `jiaofang_source` varchar(16) DEFAULT NULL COMMENT '高安椒坊字派',
  `house` varchar(16) DEFAULT NULL COMMENT '所属房：1长房 2二房 3三房 4三房织金 5四五房',
...
('全国统一字源', 'genealogy_generation_source', 0, '陈氏全国统一字辈字源，可在字典管理中增补', '1', NOW(), '1', NOW(), b'0'),
('所属房', 'genealogy_generation_house', 0, '长房、二房、三房、三房织金、四五房', '1', NOW(), '1', NOW(), b'0'),
...
(1, '永', '永', 'genealogy_generation_source', 0, '', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(2, '同', '同', 'genealogy_generation_source', 0, '', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(3, '昌', '昌', 'genealogy_generation_source', 0, '', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(4, '世', '世', 'genealogy_generation_source', 0, '', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(5, '德', '德', 'genealogy_generation_source', 0, '', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(6, '万', '万', 'genealogy_generation_source', 0, '', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(7, '文', '文', 'genealogy_generation_source', 0, '', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(8, '明', '明', 'genealogy_generation_source', 0, '', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(9, '绍', '绍', 'genealogy_generation_source', 0, '', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(10, '启', '启', 'genealogy_generation_source', 0, '', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(11, '家', '家', 'genealogy_generation_source', 0, '', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(1, '长房', '1', 'genealogy_generation_house', 0, 'danger', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(2, '二房', '2', 'genealogy_generation_house', 0, 'primary', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(3, '三房', '3', 'genealogy_generation_house', 0, '', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(4, '三房织金', '4', 'genealogy_generation_house', 0, 'success', '', NULL, '1', NOW(), '1', NOW(), b'0'),
(5, '四五房', '5', 'genealogy_generation_house', 0, 'warning', '', NULL, '1', NOW(), '1', NOW(), b'0'),
...
INSERT INTO `tb_generation` (`id`, `family_id`, `generation_no`, `word`, `national_source`, `status`, `remark`, `sort`, `tenant_id`, `creator`) VALUES
(1, 1, 1, '永', '永', 2, '始祖以下第一世', 1, 1, '1'),
(2, 1, 2, '昌', '昌', 2, NULL, 2, 1, '1'),
(3, 1, 3, '世', '世', 2, NULL, 3, 1, '1'),
(4, 1, 4, '德', '德', 2, NULL, 4, 1, '1'),
(10, 1, 4, '万', '万', 3, '同一世并行字辈示例', 41, 1, '1'),
(5, 1, 5, '文', '文', 1, '当前取名使用', 5, 1, '1'),
(6, 1, 6, '明', '明', 1, '当前取名使用', 6, 1, '1'),
(7, 1, 7, '绍', '绍', 1, '当前取名使用', 7, 1, '1'),
(8, 1, 8, '启', '启', 3, '备选字辈', 8, 1, '1'),
(9, 1, 9, '家', '家', 3, '备选字辈', 9, 1, '1');
