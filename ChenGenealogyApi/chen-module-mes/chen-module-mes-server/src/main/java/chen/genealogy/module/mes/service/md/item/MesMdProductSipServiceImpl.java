...
import chen.genealogy.module.mes.controller.admin.md.item.vo.sip.MesMdProductSipSaveReqVO;
import chen.genealogy.module.mes.dal.dataobject.md.item.MesMdProductSipDO;
import chen.genealogy.module.mes.dal.mysql.md.item.MesMdProductSipMapper;
